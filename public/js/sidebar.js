function renderSidebar(active) {
  const items = [
    ...
    { key: 'tailor', href: '/tailor.html', label: 'AI Tailor',
      icon: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><path d="M12 3v3m0 12v3m9-9h-3M6 12H3m13.4-6.4-2.1 2.1M8.7 15.3l-2.1 2.1m9.8 0-2.1-2.1M8.7 8.7 6.6 6.6"/><circle cx="12" cy="12" r="3"/></svg>' },
