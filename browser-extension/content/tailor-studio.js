...
(function (global) {
  const STYLES = `
    ...
    * { box-sizing: border-box; font-family: -apple-system, 'Segoe UI', system-ui, sans-serif; }
    ...
    /* Skeleton resume preview shown under the logo while AI matching runs */
    .ts-loading-skeleton { width: 260px; margin: 22px auto 0; display: flex; flex-direction: column; gap: 9px; }
    .ts-sk-bar { height: 9px; border-radius: 5px; background: linear-gradient(90deg, #eef0f4 25%, #e2e5ec 37%, #eef0f4 63%);
      background-size: 400% 100%; animation: ts-sk-shimmer 1.4s ease infinite; }
    @keyframes ts-sk-shimmer { 0% { background-position: 100% 50%; } 100% { background-position: 0 50%; } }
    .ts-sk-bar.w1 { width: 100%; }
    .ts-sk-bar.w2 { width: 82%; }
    .ts-sk-bar.w3 { width: 92%; }
    .ts-sk-bar.w4 { width: 60%; margin-top: 6px; }
        ...
        <div class="ts-overlay">
          ...
          <div class="ts-loading-center">
            <div class="ts-loading-inner">
              ...
              <div class="ts-loading-skeleton" aria-hidden="true">
                <div class="ts-sk-bar w1"></div>
                <div class="ts-sk-bar w2"></div>
                <div class="ts-sk-bar w3"></div>
                <div class="ts-sk-bar w4"></div>
              </div>
            </div>
          </div>
        </div>`;
