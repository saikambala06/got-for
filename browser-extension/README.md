...
- The backend's Groq-powered tailoring rewrites the summary, reorders/refines the
...
- Cover letter and tailoring both require `GROQ_API_KEY` to be configured on the
